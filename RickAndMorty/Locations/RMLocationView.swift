...
final class RMLocationView: UIView {
    ...
    private let tableView: UITableView = {
        ...
        table.alpha = 0
        table.isHidden = true
        table.register(RMLocationTableViewCell.self, forCellReuseIdentifier: RMLocationTableViewCell.reuseIdentifier)
        return table
    }()
...
extension RMLocationView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: RMLocationTableViewCell.reuseIdentifier, for: indexPath)
